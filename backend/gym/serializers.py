...
class PreferenciasDefaultSerializer(serializers.ModelSerializer):
    class Meta:
        model = PreferenciasDefault
        fields = '__all__'

class PreferenciasUsuarioOverrideSerializer(serializers.ModelSerializer):
    class Meta:
        model = PreferenciasUsuarioOverride
        fields = '__all__'